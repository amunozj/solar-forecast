...
date = datetime.datetime.strptime('20110101_0000','%Y%m%d_%H%M')
end_date = datetime.datetime.strptime('20170801_0000','%Y%m%d_%H%M')
...
while date <= end_date:
    ...
    my_file = '/home/solardynamo/AIA_data_1d/1dcad_AIA' + date_s + '_8chnls_1024_000m.fthr'
    if not os.path.isfile(my_file):
        ...
        if is_complete:
            ...
            np.save(file('/home/solardynamo/AIA_data_1d/1dcad_AIA' + date_s + '_8chnls_1024_000m.hdr','w'),chromosphere_image[1].header)
            #np.save(file('/home/solardynamo/AIA_data_Flares/%05d_12m_AIA'%(count) + date_s + '_8chnls_1024.dat','w'),data) 
            df = feather.write_dataframe(df, '/home/solardynamo/AIA_data_1d/1dcad_AIA' + date_s + '_8chnls_1024_000m.fthr')
