...
flaresCSV = pd.read_csv('flares_CMX_Flux_2010_2017.csv',header = 1)
...
while not it.finished:
    ...
    my_file = '/home/solardynamo/AIA_data_Flares/%05d_AIA'%(count) + date_s + '_8chnls_1024_012h.fthr'
    if not os.path.isfile(my_file):
        ...
        if is_complete:
            ...
            df = feather.write_dataframe(df, '/home/solardynamo/AIA_data_Flares/%05d_AIA'%(count) + date_s + '_8chnls_1024_012h.fthr')
